...
public class AnySealTest {
    ...
    public void drawStringTest() {
        ...
        graphics.drawString("陈", 10, 120);
        graphics.drawString("佳", 165, 120);
        ...
        FileUtil.writeBytes(outStream.toByteArray(), "C:\\Users\\ggk911\\IdeaProjects\\test\\src\\main\\java\\sealTest\\test2.png");
    }
