...
//	        System.out.println(Base64.toBase64String(derseq.getEncoded()));
    ...
    public void verifyP10() {
        ...
        // 红鼎
        P10 = "";
        P10 = "";
        P10 = "";
        // 申请 行
        P10 = "";
        // 续期 不行
        P10 = "";
        // 正确的
        P10 = "";

        //
        // P10 = "";
        P10 = "";

        P10 = "";

        P10 = "";
