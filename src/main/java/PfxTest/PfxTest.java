...
public class PfxTest {
    ...
    public static void main(String[] args) {
        ...
        FileUtil.writeBytes(pfx.getEncoded(), "C:\\Users\\ggk911\\IdeaProjects\\test\\src\\main\\java\\PfxTest\\pfxTest01.pfx");
    }
    ...
    private static PKCS12PfxPdu createPfx(PrivateKey privKey, PublicKey pubKey, X509Certificate[] chain) {
        ...
        // todo ??
        // pfxPduBuilder.addEncryptedData((new BcPKCS12PBEOutputEncryptorBuilder(PKCSObjectIdentifiers.pbeWithSHAAnd40BitRC2_CBC, CBCBlockCipher.newInstance(new DESedeEngine())).build(PASSWD)), certs);
